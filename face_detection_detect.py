...
def detect_faces(clf_name, img_name, stride, prob_tresh):
    ...
    locations, predictions = try_prediction(clf, image, stride, prob_tresh, False)
...
#########################################################################################
desc = """ Use a Neural Network for face detection.
...
parser.add_argument('-p', dest='prob_tresh', type=float, default=0.99)
