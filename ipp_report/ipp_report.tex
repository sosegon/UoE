...
The execution of the project is defined in a series of tasks with specific goals. Each task has a number of resources, a duration, and outcomes that might be required in a following stage as seen in Figure \ref{fig:gantt_full}. The next subsections describe the details of each task.

\begin{figure}
	\begin{center}
		\begin{ganttchart}[hgrid, vgrid, x unit=4.5mm]{1}{12}
			\gantttitlelist{1,...,12}{1} \\
			\ganttbar{Design}{1}{1} \\
			\ganttlinkedbar[name=I]{Implementation}{2}{7} \\
			\ganttbar{Ethics approval}{2}{3} \\
			\ganttbar{Recruitment}{3}{6} \\
			\ganttbar[name=T]{Testing}{8}{10} \\
			\ganttlinkedbar{Analysis}{11}{11} \\
			\ganttlinkedbar{Report}{12}{12} \\			
			\ganttbar{Documentation}{1}{12}
			\ganttlink[link mid=.4]{I}{T}
		\end{ganttchart}
	\end{center}
	\caption{Gantt chart of execution of project tasks over a period of 12 weeks.}
