...
The second risk is that the participants abandon the study. Evidently, participants will not be forced to continue in the study. To reduce the affectation of this risks, an extra number of participants will be needed. However, the abandonment of participants will also be analysed to determine its causes. The application will have a feature to survey the users when they decide to leave the study. Participants will be encouraged to complete the survey before leaving the study. 
