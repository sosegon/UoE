...
The main objective of the project is to increase the user engagement of AnkiDroid which will be reflected in an increase of its effectiveness. Thus, the following hypotheses need to be confirmed or denied:
...
\begin{displayquote}
\textbf{H2: } The participants in the experimental group will obtain higher scores than the participants in the control group in the final test.
\end{displayquote}
